...
/*  DEBUG    
    byte xmit_data[number_of_sensors * frame_len];  //define xmit_data here
*/    
...
/*      
      //DEBUG
      data_len = sizeof(xmit_data) / number_of_sensors;
      //Serial.println(data_len);

      for (i = 0; i < number_of_sensors; i++){
        for (j = (data_len * i); j < (data_len * (i + 1)); j++){
          Serial.print(xmit_data[j], HEX);
          Serial.print(" ");
        }
        Serial.println("");
      }
